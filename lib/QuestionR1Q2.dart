...
import 'package:odd_one_out/QuestionR1Q3.dart';
import 'package:odd_one_out/TutorialScreen.dart';

var inputScreen = new InputScreen();


class QuestionR1Q2 extends StatelessWidget {
  @override
...
//        ),
        appBar: AppBar(
          ...
          title: Text("Question Round 1", style: TextStyle(fontSize: 30.0,color: Colors.black),),
                    ...
                    new Container(
                      ...
                      child: ButtonTheme(
                          ...
                          child: RaisedButton(
                            ...
                            child: Text("How excited would you be to come home to this everyday?", style: TextStyle(fontSize: 30, color: Colors.white)),//preferably randomly generated from list of questions
                          )),
                    ),
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context){
                                    return QuestionR1Q3(); //would return to the first question screen
                                  }));
                                },
