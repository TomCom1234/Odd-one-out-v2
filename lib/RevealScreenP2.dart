...
import 'package:odd_one_out/AnimalRevealScreen2.dart';
import 'package:odd_one_out/InputScreen.dart';
import 'package:odd_one_out/RevealScreenP3.dart';
import 'package:odd_one_out/TutorialScreen.dart';

var inputScreen = new InputScreen();


class RevealScreenP2 extends StatelessWidget {
  @override
                ...
                new Stack(
                  ...
                  children: <Widget>[
                    ...
                    new Container(
                      ...
                      height: 400,
                      child: Text(
                        InputScreen.nameInput2.text, //could be "name1" from a list of names gathered by the input screen
                        style: TextStyle(
                          fontSize: 40.0,
                          color: Colors.white,
                        ),
