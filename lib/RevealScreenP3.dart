...
import 'package:odd_one_out/OutLoopPerson.dart';
...
class RevealScreenP3 extends StatelessWidget {
  @override
                        ...
                        Container(
                          ...
                          child: ButtonTheme(
                              ...
                              child: RaisedButton(
                                ...
                                onPressed: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context){
                                    return RevealScreenP4(); //Will return the next Reveal screen but names would be random in each one
                                  }));
                                },
